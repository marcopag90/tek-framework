...
/**
 * Configuration to allow access of different properties file through the application
 * just by using its {@link org.springframework.beans.factory.annotation.Value} injection.
 *
 * @author MarcoPagan
 */
@Configuration
