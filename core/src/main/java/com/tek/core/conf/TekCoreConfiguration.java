...
import com.tek.core.TekAbstractConfiguration;
...
@Slf4j
public class TekCoreConfiguration extends TekAbstractConfiguration {
    ...
    public TekCoreConfiguration() {
        super(TekCoreConfiguration.class);
    }
    ...
    private void checkMailErrorHandling() throws ConfigurationException {
        Boolean sendErrors = coreProperties.getMail().getSendErrors();
        Boolean isActiveScheduler = coreProperties.getScheduler().getActive();
