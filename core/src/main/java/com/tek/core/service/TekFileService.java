...
public class TekFileService {
    ...
    @NonNull private final TekDirConfiguration dirConfiguration;
     ...
     * If the file has to be created inside a directory, the fully qualified name must be provided.
     * <p>
    ...
    /**
     * Attempt to create a file inside the provided directory structure.
     * If the directory structure doesn't exist, attempts to create the directory structure first.
     * <p>
     * Returns the newly created file path.
     */
