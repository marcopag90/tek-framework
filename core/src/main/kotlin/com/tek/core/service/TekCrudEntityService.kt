...
/**
 * Service to provide bean validations and access to [TekEntityRepository] to execute _CRUD_ operations over a given [Entity].
 */
abstract class TekCrudEntityService<Entity, ID, Repository : TekEntityRepository<Entity, ID>, DTO : AbstractForm>(
...
) : ICrudEntityService<Entity, ID, DTO> {
    ...
    override fun delete(id: ID) {
        log.debug("Accessing $repository for entity: $entityClass with id:$id")
        repository.findById(id).orNull()?.let {
